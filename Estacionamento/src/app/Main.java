...
/**
 * <p>
 * Classe <b>Main</b> Recebe o método main que é o runner de toda a aplicação
 * </p>
 *
 * @author Lucas Ramon
 * @since may 2021
...
public class Main {
    ...
    public static void menu() {
        ...
        do {
             ...
             * deseja realizar; 2-Implementar os casos no switch case
             */
            ...
            /*
             * 1-Passar a string menu como parâmetro para o JOptionPane; 2-Ler a opção do
             * usuário
             */
            ...
            switch (x) {
                case 1:
                    ...
                    /*
                     * Criando um novo registro de veiculo. 1-Instanciar um novo veiculo; 2-Setar
                     * todos os atributos do veiculo; 3-Se o carro já estiver registrado, lançar a
                     * exception veiculo já cadastrado; 4-Enviar uma mensagem de sucesso,caso seja
                     * bem sucedido.
                     */
                ...
                case 2:
                    /*
                     * Criando um novo registro de veiculo mensalista 1-Instaciar um novo veiculo
                     * mensalista; 2-Setar tudo referente ao veiculo; 3-Se o veiculo já estiver
                     * registrado,lançar a exception veiculo já cadastrado; 4-Adicionar veiculo a
                     * lista; 5-Criar um objeto Proprietario; 6-Setar tudo do proprietario e
                     * adicionar vincular o veiculo
                     */

                    try {
                        Proprietario p = new Proprietario();
                        String strNome = JOptionPane.showInputDialog("Digite o nome do proprietario:");
                        p.setNome(strNome);

                        String strCnh = JOptionPane.showInputDialog("Digite o numero da CNH:");
                        p.setCnh(strCnh);

                        String strEndereco = JOptionPane.showInputDialog("Digite o endereço do proprietario:");
                        p.setEndereco(strEndereco);

                        String strNcelular = JOptionPane.showInputDialog("Digite o telefone celular:");
                        p.setnCelular(strNcelular);

                        String strNresidencial = JOptionPane.showInputDialog("Digite o telefone residencial:");
                ...
                case 3:
                    /*
                     * 1-Buscar a referencia de veiculo pela placa; 2-Setar a hora e data de entrada
                     * do veiculo; 3-Verificar o tipo de acesso; 4-Realizar o cálculo do valor a ser
                    ...
                    try {
                        ...
                        LocalDate dataEntradaRotativo = LocalDate.of(inputDataEntradaRotativo[2],
                                inputDataEntradaRotativo[1], inputDataEntradaRotativo[0]);
                        ...
                        LocalTime horaEntradaRotativo = LocalTime.of(inputHoraEntradaRotativo[0],
                                inputHoraEntradaRotativo[1]);
                        ...
                        LocalDate dataSaidaRotativo = LocalDate.of(inputDataSaidaRotativo[2], inputDataSaidaRotativo[1],
                                inputDataSaidaRotativo[0]);
                        ...
                        LocalTime horaSaidaRotativo = LocalTime.of(inputHoraSaidaRotativo[0],
                                inputHoraSaidaRotativo[1]);
                ...
                case 4:
                    /*
                     * 1-Perguntar para o usuario qual é a placa do veiculo; 2-Colocar em uma
                     * variável local o retorno da consulta feita; 3-Instanciar um acesso de acordo
                     * com o tempo de permanênica no estacionamento (acesso: minuto,por 15
                     * minutos,por hora,por diaria,pernoite); 4-Setar atributos do acesso; 3-Colocar
                     * o acesso na referencia de acessos de veiculo;
                     */
                    /*
                     * 1-O método buscar procura na lista de veículos a referência pela a
                     * placa,atribuindo como resultado da busca o objeto procurado haja vista que o
                    ...
                    /*
                     * O método lerData é utlizado para quebrar a String que é retornada pelo
                     * JOptionPane.showInputDialog; Ele basicamente retorna um vetor de inteiros de
                     * três posições(inputDataEntrada) que é utilizado para setar a data no Objeto
                     * dataEntrada;
                     */
                    try {
                        ...
                        LocalDate dataEntrada = LocalDate.of(inputDataEntrada[2], inputDataEntrada[1],
                                inputDataEntrada[0]);

                        /*
                         * O método lerHora é utilizado para quebrar a String que é retornada pelo
                         * JOptionPane.showInputDialog; Ele basicamente retorna um vetor de inteiros de
                         * duas posições(inputHoraEntrada) que é utlizado para setar a hora no Objeto
                         * horaEntrada;
                         */
                        ...
                        /*
                         * O método setEntrada utiliza uma data e uma hora para setar a entrada; Esta
                         * data e hora foram obtidas pelo processos descritos acima.
                         */
                    ...
                    /*
                     * O método calculaDuracao é basicamente um setter especial. Ele utiliza os
                     * atributos entrada e saída para calcular a duração e setar no atributo duracao
                     * do objeto acesso
                     */

                    /*
                     * O calculaPeriodo é basciamente um setter especial. Ele utiliza os atributos
                     * entrada e saída para calcular
                     * 
                     */
